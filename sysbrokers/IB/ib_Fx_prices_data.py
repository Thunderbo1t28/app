...
class ibFxPricesData(brokerFxPricesData):
    ...
    def get_list_of_fxcodes(self) -> list:
        try:
            ...
            print("Can't get list of fxcodes for IB as config file missing")
            return []
    ...
    def _get_fx_prices_without_checking(self, currency_code: str) -> fxPrices:
        try:
            ...
            print(f"Can't get prices as missing IB config for {currency_code}")
    ...
    def _get_fx_prices_with_ib_config(
        ...
        if len(raw_fx_prices_as_series) == 0:
            ...
            print(f"No available IB prices for {currency_code} {str(ib_config_for_code)}")
            return fxPrices.create_empty()
        ...
        print(f"Downloaded {len(fx_prices)} prices")
    ...
    def _get_config_info_for_code(self, currency_code: str) -> ibFXConfig:
        ...
        try:
            ...
            print(f"Can't get IB FX config for {currency_code} as config file missing")
