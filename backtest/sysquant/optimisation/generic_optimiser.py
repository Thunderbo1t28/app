...
from backtest.sysquant.optimisation.optimise_over_time import optimiseWeightsOverTime
from backtest.sysquant.optimisation.SR_adjustment import adjust_dataframe_of_weights_for_SR_costs
from backtest.sysquant.returns import returnsForOptimisation, SINGLE_NAME
...
class genericOptimiser(object):
    ...
    def optimiser(self) -> optimiseWeightsOverTime:
        optimiser = optimiseWeightsOverTime(
            self.net_returns,  **self.weighting_params
        )
        return optimiser
