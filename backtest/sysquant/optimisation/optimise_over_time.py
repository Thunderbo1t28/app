...
from backtest.sysquant.fitting_dates import generate_fitting_dates, listOfFittingDates
from backtest.sysquant.optimisation.portfolio_optimiser import portfolioOptimiser
...
class optimiseWeightsOverTime(object):
    def __init__(
        ...
        **kwargs,
        ...
        optimiser_for_one_period = portfolioOptimiser(net_returns, **kwargs)
