import pandas as pd
import numpy as np
from backtest.sysquant.estimators.stdev_estimator import empty_stdev

from quotes.syscore.pandas.pdutils import (
    apply_with_min_periods,
)
from quotes.syscore.pandas.find_data import get_max_index_before_datetime
from quotes.syscore.pandas.frequency import how_many_times_a_year_is_pd_frequency

from backtest.sysquant.fitting_dates import fitDates
from backtest.sysquant.estimators.generic_estimator import (
    genericEstimator,
