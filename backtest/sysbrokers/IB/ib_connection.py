...
from backtest.sysbrokers.IB.ib_connection_defaults import ib_defaults
...
class connectionIB(object):
    ...
    def _init_connection(
        ...
        try:
            ...
            print("Broker account ID not found in private config - may cause issues")
    ...
    def close_connection(self):
        ...
        print(f"Terminating {str(self._ib_connection_config)}")
        try:
            ...
            print("Trying to disconnect IB client failed... ensure process is killed")
