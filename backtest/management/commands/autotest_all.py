...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        instruments = ['MGNT', 'NG', 'PLZL', 'ALRS', 'AFKS', 'VTBR', 'Eu', 'SNGR', 'Si', 'PLD', 'GMKN', 'SNGP', 'NLMK', 'GAZR', 'NOTK', 'RTKM', 'MAGN','MXI', 'ROSN', 'SBPR', 'SBRF', 'MTSI', 'FEES']

        #instrument = 'MIX', 'MGNT', 'NG', 'PLZL', 'YNDF', 'CHMF', 'ALRS', 'TRY', 'AFKS', 'VTBR', 'Eu', 'SNGR', 'SIBN', 'MVID', 'SGZH', 'Si', 'PLD', 'POLY','BELU', 'OZON', 'MTLR', 'GMKN', 'HANG', 'SNGP', 'HKD', 'NLMK', 'KMAZ', 'RUAL', 'GAZR', 'NOTK', 'UCNY', 'CNY', 'RTKM', 'MAGN','MXI', 'ROSN', 'SBPR', 'SBRF', 'MTSI', 'AFLT', 'HOME', 'FIVE', 'WHEAT', 'FEES'
