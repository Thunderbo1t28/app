...
def apply_price_cleaning(
    ...
    if cleaning_config.ignore_future_prices:
        ...
        if new_price_length < price_length:
            ...
            print(f"Ignoring {(price_length - new_price_length)} prices with future timestamps")
            price_length = new_price_length
    ...
    if ignore_prices_with_zero_volumes:
        ...
        if new_price_length < price_length:
            ...
            print(f"Ignoring {(price_length - new_price_length)} prices with zero volumes")
            price_length = new_price_length
    ...
    if cleaning_config.ignore_zero_prices:
        ...
        if new_price_length < price_length:
            ...
            print(f"Ignoring {(price_length - new_price_length)} prices with zero prices")
            price_length = new_price_length
