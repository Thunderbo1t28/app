...
from quotes.syscore.pandas.merge_data_keeping_past_data import SPIKE_IN_DATA
from quotes.syscore.pandas.frequency import (
    sumup_business_days_over_pd_series_without_double_counting_of_closing_data,
)
from quotes.syscore.pandas.merge_data_keeping_past_data import merge_newer_data
from quotes.syscore.pandas.full_merge_with_replacement import full_merge_of_existing_data
...
class futuresContractPrices(pd.DataFrame):
    ...
    def __init__(self, price_data_as_df: pd.DataFrame):
        ...
        self._as_df = price_data_as_df.copy()
