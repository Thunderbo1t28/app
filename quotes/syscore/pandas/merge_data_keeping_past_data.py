...
from quotes.syscore.dateutils import SECONDS_PER_DAY
from quotes.syscore.constants import named_object, arg_not_supplied
from quotes.syscore.pandas.pdutils import is_a_series
