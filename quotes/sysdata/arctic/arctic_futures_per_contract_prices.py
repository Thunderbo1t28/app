...
from quotes.syscore.dateutils import Frequency, MIXED_FREQ

from quotes.sysdata.arctic.arctic_connection import arcticData
from quotes.sysdata.futures.futures_per_contract_prices import (
    futuresContractPriceData,
    listOfFuturesContracts,
)
from quotes.sysobjects.futures_per_contract_prices import futuresContractPrices
from quotes.sysobjects.contracts import futuresContract, get_code_and_id_from_contract_key
#from quotes.syslogging.logger import *
...
class arcticFuturesContractPriceData(futuresContractPriceData):
    ...
    def _delete_prices_at_frequency_for_contract_object_with_no_checks_be_careful(
        ...
        '''
        print(f"Deleted all prices for {futures_contract_object.key} from {str(self)}")
