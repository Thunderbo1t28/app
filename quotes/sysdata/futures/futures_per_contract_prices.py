...
from quotes.syscore.pandas.merge_data_keeping_past_data import SPIKE_IN_DATA, mergeError
...
from quotes.sysobjects.dict_of_futures_per_contract_prices import dictFuturesContractPrices
