...
from quotes.sysobjects.rolls import rollParameters, contractDateWithRollParameters
from quotes.sysobjects.contract_dates_and_expiries import contractDate

from quotes.sysdata.csv.csv_roll_calendars import csvRollCalendarData
...
from quotes.sysinit.futures.build_roll_calendars import adjust_to_price_series
...
def add_phantom_row(
    ...
    # Преобразовать в формат datetime.datetime
    #final_row_datetime = final_row.name.to_pydatetime()
